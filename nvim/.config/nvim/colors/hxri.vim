...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("NonText", "00ffff", "ffffff", "") " after the end of a file.

    " Search
    call <SID>X("Search", "000000", "00ffff", "")
    ...
    call <SID>X("CursorLine", "", "88ffff", "")
    call <SID>X("LineNr", "ffffff", "88ffff", "")
    call <SID>X("MatchParen", "", "", "")
    call <SID>X("Visual", "eeeeee", "333333", "")

    " TODO 
    " Specials
    call <SID>X("Todo", "00ffff", "eeeeee", "bold")
...
"hi VertSplit ctermfg=241 ctermbg=241 cterm=NONE guifg=#64645e guibg=#64645e gui=NONE
    ...
    " Syntax Elements
    call <SID>X("String", "00c0c0", "", "")
    call <SID>X("Constant", "00c0c0", "", "")
    call <SID>X("Number", "00c0c0", "", "")
    call <SID>X("Statement", "000000", "", "")
    call <SID>X("Function", "22ffff", "", "")
    call <SID>X("PreProc", "000000", "", "")
    call <SID>X("Comment", "000000", "", "bold")
    " call <SID>X("Comment", "cccccc", "", "")
    call <SID>X("Type", "333333", "", "")
    call <SID>X("Error", "ffffff", "00d0d0", "")
